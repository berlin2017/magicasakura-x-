...
package cn.lonsun.magicasakura.utils;
...
import cn.lonsun.magicasakura.drawables.FilterableStateListDrawable;
    ...
    public Drawable inflateDrawable(Context context, XmlPullParser parser, AttributeSet attrs) throws IOException, XmlPullParserException {
        ...
        while ((type = parser.next()) != XmlPullParser.END_DOCUMENT
            ...
            if (dr == null) {
                ...
                ColorFilter colorFilter = DrawableUtils.getAttrColorFilter(context, attrs, R.attr.drawableTint, R.attr.msDrawableTintMode);
                if (colorFilter != null) {
